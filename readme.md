...
The simplest way to use `astro-html-kit` is as an Astro integration. This enables auto-importing of image assets in your `.astro` files so you can write `src="../assets/photo.jpg"` as a string and have it resolved to an ESM import automatically:
...
```astro
---
import { Image, Picture, Video } from 'astro-html-kit/components'
...
```astro
---
import { Image } from 'astro-html-kit/components'
...
```astro
---
import { Picture } from 'astro-html-kit/components'
...
```astro
---
import { Video } from 'astro-html-kit/components'
---
...
```astro
---
import { Audio } from 'astro-html-kit/components'
---
...
The `htmlKit()` integration registers Vite plugins in `astro:config:setup`. All options are optional.
...
```ts
import htmlKit, { tldrawDarkImport } from 'astro-html-kit'
